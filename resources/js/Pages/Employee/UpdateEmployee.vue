<script setup>
    ...
    watch(dialogVisible, async (dialogVisible, prevVal) => {
        ...
        formEmployee.lastName = employee.value.last_name
        formEmployee.firstName = employee.value.first_name
        formEmployee.middleName = employee.value.middle_name
        formEmployee.address = employee.value.address
        formEmployee.departmentId = employee.value.department_id
        formEmployee.countryId = employee.value.country_id
        states.value = await getStates(formEmployee.countryId)
        formEmployee.stateId = employee.value.state_id
        cities.value = await getCities(formEmployee.stateId)
        formEmployee.cityId = employee.value.city_id
        formEmployee.zipcode = employee.value.zipcode
    })
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="py-6 px-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Update employee</h3>
                    <div class="width-300">
                        <div>
                        ...
                        <button @click="updateEmployee" class="mt-4 w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update</button>
                    </div>
                </div>
            </div>
        </div>

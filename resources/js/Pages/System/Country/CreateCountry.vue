<script setup>
    ...
    const formCountry = reactive({...form})

    async function createCountry() {
        console.log('formCountry ', formCountry)
        const result = await axios.post(`/api/countries`, formCountry)

        emit('getCountries')
        emit('closeDialog', `Country ${formCountry.name} has been created`)

        Object.assign(formCountry, form)
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="py-6 px-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Create country</h3>
                    <div class="width-300">
                        <div>
                        ...
                        <div class="my-0">
                            ...
                            <input type="text" v-model="formCountry.name" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="" required="">
                        </div>
                        <button @click="createCountry" class="mt-4 w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create</button>
                    </div>
                </div>
            </div>
        </div>

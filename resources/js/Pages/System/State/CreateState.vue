<script setup>
    ...
    async function createState() {
        ...
        const result = await axios.post(`/api/states`, formStates)

        emit('getStates')
        emit('closeDialog', `State ${formStates.name} has been created`)
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <div class="width-300">
                        ...
                        <button @click="createState" class="mt-4 w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create</button>
                    </div>
                </div>
            </div>
        </div>

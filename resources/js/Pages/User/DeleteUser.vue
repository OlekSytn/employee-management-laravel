<script setup>
    ...
    async function deleteUser() {
        ...
        emit('getUsers')
        emit('closeDialog', `User ${user.value.username} has been deleted`)
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <button @click="deleteUser" class="w-full text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Delete</button>
                    </div>
                </div>
            </div>
        </div>

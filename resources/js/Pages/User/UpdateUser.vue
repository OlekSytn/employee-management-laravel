<script setup>
    ...
    const { dialogVisible, user } = toRefs(props)
    ...
    watch(dialogVisible, (dialogVisible, prevVal) => {
        ...
        formUser.firstName = user.value.first_name
        formUser.lastName = user.value.last_name
    })
    ...
    async function updateUser() {
        ...
        emit('getUsers')
        emit('closeDialog', `User ${user.value.username} has been updated`)
